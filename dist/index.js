...
var require_defaults = __commonJS({
  "node_modules/ajv/dist/compile/validate/defaults.js"(exports) {
    ...
    function assignDefaults(it, ty) {
      const { properties: properties3, items } = it.schema;
      if (ty === "object" && properties3) {
        for (const key in properties3) {
          assignDefault(it, key, properties3[key].default);
        }
...
var require_code2 = __commonJS({
  "node_modules/ajv/dist/vocabularies/code.js"(exports) {
    ...
    function checkMissingProp({ gen, data, it: { opts } }, properties3, missing) {
      return (0, codegen_1.or)(...properties3.map((prop) => (0, codegen_1.and)(noPropertyInData(gen, data, prop, opts.ownProperties), (0, codegen_1._)`${missing} = ${prop}`)));
    }
  ...
  "node_modules/ajv/dist/core.js"(exports) {
    ...
    var Ajv2 = class {
      ...
      validateSchema(schema, throwOrLogError) {
        ...
        if ($schema3 !== void 0 && typeof $schema3 != "string") {
          throw new Error("$schema must be a string");
        }
        $schema3 = $schema3 || this.opts.defaultMeta || this.defaultMeta();
        if (!$schema3) {
          this.logger.warn("meta-schema not available");
          this.errors = null;
          return true;
        }
        const valid = this.validate($schema3, schema);
  ...
  "node_modules/ajv/dist/vocabularies/applicator/properties.js"(exports) {
    ...
    var def = {
      ...
      code(cxt) {
        ...
        const properties3 = allProps.filter((p) => !(0, util_1.alwaysValidSchema)(it, schema[p]));
...
// ../shared/github-sarif-schema.json
...
// src/matchers/valid-github-sarif-log.ts
var import_ajv_formats = __toESM(require_dist());

// ../shared/sarif-schema-2.1.0.json
...
var sarif_schema_2_1_0_default = {
  $schema: $schema2,
  title: title2,
  $id: $id2,
  description: description2,
...
var toBeValidGithubSarifLog = (actual) => {
  if (!actual) {
    return {
      pass: false,
  ...
  ajv.addSchema(
    sarif_schema_2_1_0_exports,
    "https://docs.oasis-open.org/sarif/sarif/v2.1.0/errata01/os/schemas/sarif-schema-2.1.0.json"
  );
  const validate = ajv.compile(github_sarif_schema_exports);
  const isValid = validate(actual);
  return {
    pass: isValid,
    message: () => isValid ? "Expected a valid GitHub SARIF log, but received an invalid one." : `Validation failed. ${ajv.errorsText(validate.errors)}`
  };
};
expect.extend({
