...
var $id = "https://yoursite.com/schemas/sarif-github-extended-schema.json";
...
var allOf = [
  {
    $ref: "https://raw.githubusercontent.com/oasis-tcs/sarif-spec/123e95847b13fbdd4cbe2120fa5e33355d4a042b/Schemata/sarif-schema-2.1.0.json"
  }
];
var properties = {
  runs: {
...
// src/matchers/valid-github-sarif-log.ts
function toBeValidGithubSarifLog() {
  return (received) => {
    if (!received) {
      return {
        actual: received,
